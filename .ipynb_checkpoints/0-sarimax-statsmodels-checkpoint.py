...
# dynamic forecast
fcast = co2sar.get_prediction(start=pd.to_datetime('1979-4-30'), 
                              dynamic=True, 
                              full_results=True)
fcast_ci = fcast.conf_int()

# **Note**: The dynamic keyword affects in-sample prediction. If dynamic is  
# False, then the in-sample lagged values are used for prediction. If dynamic  
